...
export default function CompanyLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Access your employer dashboard</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              New employer?{' '}
              <Link to="/company/register" className="text-blue-600 font-medium hover:text-blue-700">
